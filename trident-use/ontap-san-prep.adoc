...
----
+
++ HINWEIS: Nach Ausführung dieses Befehls fordert ONTAP die Eingabe eines Zertifikats an. Fügen Sie den Inhalt der  `k8senv.pem` Datei ein, die in Schritt 1 generiert wurde, und drücken Sie  `END`, um die Installation abzuschließen.
