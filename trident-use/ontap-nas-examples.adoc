...
[role="lead"]
Erfahren Sie, wie Sie ONTAP NAS-Treiber mit Ihrer Astra Trident Installation erstellen und verwenden. Dieser Abschnitt enthält Beispiele für die Back-End-Konfiguration und Details zur Zuordnung von Back-Ends zu StorageClasses.
...
Kann so eingestellt werden, dass IPv6-Adressen verwendet werden, wenn Astra Trident mit installiert wurde `--use-ipv6` Flagge. IPv6-Adressen müssen in eckigen Klammern definiert werden, z. B. [28e8:d9fb:a825:b7bf:69a8:d02f:9e7b:3555]. | Angegebene Adresse oder abgeleitet von SVM, falls nicht angegeben (nicht empfohlen) 
...
| `limitVolumeSize` | Bereitstellung fehlgeschlagen, wenn die angeforderte Volume-Größe über diesem Wert liegt. | „“ (standardmäßig nicht erzwungen) 
...
| `snapshotReserve` | Prozentsatz des für Snapshots reservierten Volumes „0“ | Wenn `snapshotPolicy` Ist „keine“, sonst „“ 
...
| `tieringPolicy` | Tiering-Richtlinie zu „keine“ | „Nur Snapshot“ für eine ONTAP 9.5 SVM-DR-Konfiguration 
...
.Minimalkonfiguration für <code>ontap-nas-economy</code>
[%collapsible%open]
====
[listing]
----
...
----
====
.Minimalkonfiguration für <code>ontap-nas-flexgroup</code>
[%collapsible%open]
====
[listing]
----
...
----
====
.Minimale Konfiguration für SMB Volumes
[%collapsible%open]
====
[listing]
----
...
----
====
.Amazon FSX für ONTAP, die SMB Volumes nutzen
[%collapsible%open]
====
